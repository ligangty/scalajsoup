...
//    val spanText: TextNode = span.childNode(0).asInstanceOf[TextNode]
//    assert("two &" == spanText.text)
//    val tn: TextNode = p.childNode(2).asInstanceOf[TextNode]
...
//    val tn: TextNode = div.childNode(0).asInstanceOf[TextNode]
