...
//    val newNode: Element = new Element(Tag.valueOf("em"), "")
...
//    val twoText: Node = span.childNode(0)
...
//    doc.select("div").first.traverse( new class null {
...
//    val node: Node = new Element(Tag.valueOf("p"), "")
//    val el: Element = new Element(Tag.valueOf("p"), "")
...
//    assert(2 == nodes.size)
//    assert("<p>One</p>" == nodes.get(0).outerHtml)
//    assert("<p>Three</p>" == nodes.get(1).outerHtml)
//  }
//
//  test("childNodesCopy") {
...
//    val divChildren: List[Node] = div1.childNodesCopy
//    assert(5 == divChildren.size)
//    val tn1: TextNode = div1.childNode(0).asInstanceOf[TextNode]
//    val tn2: TextNode = divChildren.get(0).asInstanceOf[TextNode]
